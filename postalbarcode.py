# Postal bar code generator #
# Amos Heil and Dillon Wilcox #
# Program creates a postal bar code and a check sum digit #
# It then uses the draw module to present it with the checksum added to the end #
...
def main():
    '''to add a basic function this was the
    starting point to then break up our code
    into modules to import'''
